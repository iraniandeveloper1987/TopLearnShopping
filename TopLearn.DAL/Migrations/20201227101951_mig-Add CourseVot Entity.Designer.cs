...
namespace TopLearn.DAL.Migrations
{
    ...
    [Migration("20201227101951_mig-Add CourseVot Entity")]
    partial class migAddCourseVotEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopLearn.DAL.Entities.Comment.CourseComment", b =>
                {
            ...
            modelBuilder.Entity("TopLearn.DAL.Entities.Course.CourseVote", b =>
                {
                    b.Property<int>("CourseVoteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TopLearn.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterDate = new DateTime(2020, 12, 27, 13, 49, 49, 691, DateTimeKind.Local).AddTicks(3990),
            ...
            modelBuilder.Entity("TopLearn.DAL.Entities.Comment.CourseComment", b =>
                {
                    b.HasOne("TopLearn.DAL.Entities.Comment.CourseComment", null)
